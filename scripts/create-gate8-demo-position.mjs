...
const evidence = {
  purpose: "Gate 8 frontend money-shot demo position",
...
writeFileSync(new URL("./demo-position.json", `file://${outDir}/`), JSON.stringify(evidence, null, 2));
console.log("\nWritten to data/gate8/demo-position.json");
